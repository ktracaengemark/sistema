...
function whatsapp(celularcliente){
	window.open('https://api.whatsapp.com/send?phone=55'+celularcliente+'&text=','1366002941508','width=700,height=350,left=375,right=375,top=300');
}
			...
			success: function (data) {
				...
				$("#NomeClienteAuto1").html('\
												<label>\
													...
													<a href="https://api.whatsapp.com/send?phone=55' + celularcliente + '&text=" target="_blank" style="">\
