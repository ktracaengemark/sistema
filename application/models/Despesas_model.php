...
class Despesas_model extends CI_Model {
    ...
    public function list_despesas_pesquisar_funcionando($data, $completo, $total = FALSE, $limit = FALSE, $start = FALSE, $date = FALSE) {
    ...
    public function list_despesas_combinar($data, $completo, $total = FALSE, $limit = FALSE, $start = FALSE, $date = FALSE) {
		...
		if($data != FALSE){
			...
			$data['TipoFinanceiroR'] = ($_SESSION['FiltroDespesas']['TipoFinanceiroR']) ? ' AND TR.idTab_TipoFinanceiro = ' . $_SESSION['FiltroDespesas']['TipoFinanceiroR'] : FALSE;
