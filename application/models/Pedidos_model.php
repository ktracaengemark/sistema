...
class Pedidos_model extends CI_Model {
    ...
    public function list_pedidos_pesquisar_original($data, $completo) {
    ...
    public function list_pedidos_combinar_original($data, $completo) {
    ...
    public function list_pedidos_aprovar_original($data, $completo) {
    ...
    public function list_pedidos_producao_original($data, $completo) {
    ...
    public function list_pedidos_envio_original($data, $completo) {
    ...
    public function list_pedidos_entrega_original($data, $completo) {
    ...
    public function list_pedidos_pagamento_original($data, $completo) {
    ...
    public function list_pedidos_combinar($data, $completo, $total = FALSE, $limit = FALSE, $start = FALSE, $date = FALSE) {
		...
		if($data != FALSE){
			...
			$date_inicio_entrega = ($_SESSION['FiltroPedidos']['DataInicio2']) ? 'OT.DataEntregaOrca >= "' . $_SESSION['FiltroPedidos']['DataInicio2'] . '" AND ' : FALSE;
			$date_fim_entrega = ($_SESSION['FiltroPedidos']['DataFim2']) ? 'OT.DataEntregaOrca <= "' . $_SESSION['FiltroPedidos']['DataFim2'] . '" AND ' : FALSE;
