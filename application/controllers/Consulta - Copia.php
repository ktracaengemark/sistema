...
class Consulta extends CI_Controller {
									...
									if ($data['cadastrar']['Repetir'] == 'S') {
										for($j=1; $j<$qtd; $j++) {
											$data['repeticao'][$j] = array(
												...
												'NivelAgenda' 			=> $data['query']['NivelAgenda']
											);
    ...
    public function cadastrar_extra($idApp_Cliente = NULL, $repeticao_extra = NULL) {
        ...
        elseif ($this->input->get('m') == 3)
			...
			if ($repeticao_extra) {
				$_SESSION['Consulta'] = $data['consulta_extra'] = $this->Consulta_model->get_repeticao($repeticao_extra); //pego os dados dessa repetição

				if($data['consulta_extra'] === FALSE){
					...
					$data['query']['idApp_ClienteDep'] = $data['consulta_extra']['idApp_ClienteDep'];
					$data['query']['idApp_ClientePet'] = $data['consulta_extra']['idApp_ClientePet'];
					$data['query']['Obs'] = $data['consulta_extra']['Obs'];
					$data['query']['idTab_Status'] = $data['consulta_extra']['idTab_Status'];
					$data['query']['idApp_Agenda'] = $data['consulta_extra']['idApp_Agenda'];
					
					$dataini = explode(' ', $data['consulta_extra']['DataInicio']);
					$datafim = explode(' ', $data['consulta_extra']['DataFim']);
			...
			if(!$_SESSION['Consulta']){
				...
				$_SESSION['Cliente'] = $data['cliente'] = $this->Cliente_model->get_cliente($_SESSION['Consulta']['idApp_Cliente'], TRUE);
				...
				if($data['cliente'] === FALSE){
					...
					$_SESSION['Datas']['DataTermino'] = $this->basico->mascara_data($_SESSION['Consulta']['DataTermino'], 'barras');
					...
					if ($this->form_validation->run() === FALSE) {
						...
						if ($this->form_validation->run() === FALSE) {
							...
							if($this->Basico_model->get_dt_validade() === FALSE){
								...
								$data['query']['idSis_Empresa'] = $_SESSION['log']['idSis_Empresa'];
								$data['query']['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
								$data['query']['NivelAgenda'] = $_SESSION['Consulta']['NivelAgenda'];
										...
										if ($data['cadastrar']['Repetir'] == 'S') {
											for($j=1; $j<$qtd; $j++) {
												$data['repeticao'][$j] = array(
													...
													'OS' 					=> $data['query']['OS'],
													'idApp_Agenda' 			=> $data['query']['idApp_Agenda'],
													'idApp_Cliente' 		=> $_SESSION['Consulta']['idApp_Cliente'],
									...
									if($data['cadastrar']['Extra'] == 'S'){
										...
										if($data['cadastrar']['Hidden_Caso'] == 0){
											...
											if($data['cadastrar']['Adicionar'] == "S"){	
												if($data['cadastrar']['PorConsulta'] == "S"){
													//Gera O.S. Replicadas pelo número de ocorrências
													redirect(base_url() . 'orcatrata/cadastrarrepet/' . $_SESSION['Consulta']['idApp_Cliente'] . '/' . $data['query']['idApp_Consulta'] . $data['msg']);
													exit();
												}else{
													if($data['query']['Recorrencias'] > 1){
														if($data['cadastrar']['NovaOS'] == "S"){
    ...
    public function cadastrar_extra_Original($idApp_Cliente = NULL, $repeticao_extra = NULL) {
		...
		if ($repeticao_extra) {
            $verificacao = $this->Consulta_model->get_repeticao_verificacao($repeticao_extra);
		...
		if($seguir === FALSE){
			...
			*/
			if ($repeticao_extra) {
				...
				if(!$data['consulta_extra']['Repeticao'] || $_SESSION['Consulta'] === FALSE){
					...
					$data['query']['HoraInicio'] = substr($dataini[1], 0, 5);
					$data['query']['HoraFim'] = substr($datafim[1], 0, 5);
					$_SESSION['Datas']['DataInicio'] = $dataini[0];
					$_SESSION['Datas']['DataFim'] = $datafim[0];
				}
			...
			if($_SESSION['Consulta'] === FALSE){
				...
				$_SESSION['Cliente'] = $this->Cliente_model->get_cliente($_SESSION['Consulta']['idApp_Cliente'], TRUE);
    ...
    public function alterar($idApp_Cliente = NULL, $idApp_Consulta = FALSE) {
        ...
        elseif ($this->input->get('m') == 3)
			...
			if ($idApp_Consulta) {
				...
				if($data['query'] === FALSE  || $data['query']['Tipo'] == 1){
			...
			if(!$data['query']['idApp_Consulta'] || !$_SESSION['Consulta'] || $_SESSION['Consulta']['Tipo'] == 1){
				...
				if($data['cliente'] === FALSE){
					...
					$dataini2 = explode(' ', $_SESSION['Consulta']['DataInicio']);
					$datafim2 = explode(' ', $_SESSION['Consulta']['DataFim']);				
					$_SESSION['Datas']['DataInicio'] = $dataini2[0];
					$_SESSION['Datas']['DataFim'] = $datafim2[0];
					...
					$data['select']['Status'] = $this->Basico_model->select_status();
					$data['select']['TipoConsulta'] = $this->Basico_model->select_tipo_consulta();
					//$data['select']['ContatoCliente'] = $this->Consulta_model->select_contatocliente_cliente($_SESSION['Cliente']['idApp_Cliente']);
						...
						if ($this->form_validation->run() === FALSE) {
							...
							if($this->Basico_model->get_dt_validade() === FALSE){
								...
								*/
								...
								$dataanteriorinicio = strtotime($_SESSION['Datas']['DataInicio']);
								$dataanteriorfim = strtotime($_SESSION['Datas']['DataFim']);
								...
								$data['update']['cliente_repeticao']['anterior'] = $this->Orcatrata_model->get_cliente($_SESSION['Consulta']['idApp_Cliente']);
								...
								if($data['query']['idApp_OrcaTrata'] != 0){
									...
									if($data['repeticaocons'] == $data['repeticaoorca']){
										...
										if(isset($_SESSION['Consulta']['idApp_Cliente']) && $_SESSION['Consulta']['idApp_Cliente'] !=0){
											...
											if(strtotime($data['update']['cliente_repeticao']['anterior']['UltimoPedido']) < strtotime($data['orca']['DataOrca'])){
												...
												$data['update']['cliente_repeticao']['bd'] = $this->Orcatrata_model->update_cliente($data['cliente_repeticao'], $_SESSION['Consulta']['idApp_Cliente']);
												...
												if($data['update']['cliente_repeticao']['anterior']['id_UltimoPedido'] == $data['query']['idApp_OrcaTrata']){
													...
													$data['get_ult_pdd_cliente'] = $this->Orcatrata_model->get_ult_pdd_cliente($_SESSION['Consulta']['idApp_Cliente'], TRUE);
									...
									if (isset($data['repeticao'])) {
										for($j=1; $j <= $max; $j++) {
											...
											if($data['repeticao'][$j]['idApp_Consulta'] != $data['query']['idApp_Consulta']){
												...
												$data['repeticao'][$j]['idApp_Cliente'] 		= $_SESSION['Consulta']['idApp_Cliente'];
								...
								if(!isset($data['query']['idApp_OrcaTrata']) || (isset($data['query']['idApp_OrcaTrata']) && $data['query']['idApp_OrcaTrata'] == 0) || $data['query']['idApp_OrcaTrata'] == ""){
									...
									//Não Gera O.S.
									unset($_SESSION['Agenda'], $_SESSION['Cliente'], $_SESSION['Consulta'], $_SESSION['Consultas_Repet'], $_SESSION['Repeticao'], $_SESSION['Datas']);
    ...
    public function alterar_Original($idApp_Cliente = NULL, $idApp_Consulta = FALSE) {
        ...
        elseif ($this->input->get('m') == 3)
			...
			*/
			...
			if(!$data['query']['idApp_Consulta'] || !$_SESSION['Consulta']){
    ...
    public function excluir($id = FALSE) {
        ...
        elseif ($this->input->get('m') == 2)
			...
			if (!$id) {
				...
				$_SESSION['Consulta'] = $data['anterior'] = $this->Consulta_model->get_consulta($id);
					
				if($data['anterior'] === FALSE || $data['anterior']['Tipo'] == 1){
					...
					$_SESSION['Cliente'] = $data['cliente'] = $this->Cliente_model->get_cliente($data['anterior']['idApp_Cliente'], TRUE);
    ...
    public function cadastrar_evento_extra($repeticao_extra = NULL) {
        ...
        elseif ($this->input->get('m') == 3)
			...
			if ($repeticao_extra) {
				...
				if($data['consulta_extra'] === FALSE || $data['consulta_extra']['Tipo'] == 2){
			...
			if(!$_SESSION['Consulta'] || $_SESSION['Consulta']['Tipo'] == 2){
    ...
    public function alterar_evento($idApp_Consulta = FALSE) {
        ...
        elseif ($this->input->get('m') == 3)
			...
			if ($idApp_Consulta) {
				...
				if($data['query'] === FALSE || $data['query']['Tipo'] == 2){
			...
			if(!$data['query']['idApp_Consulta'] || !$_SESSION['Consulta'] || $_SESSION['Consulta']['Tipo'] == 2){
    ...
    public function excluir_evento($id = FALSE) {
        ...
        elseif ($this->input->get('m') == 2)
			...
			if (!$id) {
				...
				if($data['anterior'] === FALSE || $data['anterior']['Tipo'] == 2){
