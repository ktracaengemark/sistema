...
class Pedidos_statico_pag extends CI_Controller {
    ...
    public function pedidos() {
        ...
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos';
    ...
    public function pedidos_combinar_pag() {
        ...
        $data['titulo'] = 'Estático';
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos_combinar_pag';
		$data['comissao'] = 'relatorio/comissao/';
        $data['status'] = 'Orcatrata/alterarstatus/';
		$data['imprimir'] = 'OrcatrataPrintComissao/imprimir/';
        $data['nome'] = 'NomeColaborador';
    ...
    public function pedidos_aprovar_pag() {
        ...
        $data['titulo'] = 'Estático';
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos_aprovar_pag';
		$data['comissao'] = 'relatorio/comissao/';
        $data['status'] = 'Orcatrata/alterarstatus/';
		$data['imprimir'] = 'OrcatrataPrintComissao/imprimir/';
        $data['nome'] = 'NomeColaborador';
    ...
    public function pedidos_producao_pag() {
        ...
        $data['titulo'] = 'Estático';
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos_producao_pag';
		$data['comissao'] = 'relatorio/comissao/';
        $data['status'] = 'Orcatrata/alterarstatus/';
		$data['imprimir'] = 'OrcatrataPrintComissao/imprimir/';
        $data['nome'] = 'NomeColaborador';
    ...
    public function pedidos_envio_pag() {
        ...
        $data['titulo'] = 'Estático';
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos_envio_pag';
		$data['comissao'] = 'relatorio/comissao/';
        $data['status'] = 'Orcatrata/alterarstatus/';
		$data['imprimir'] = 'OrcatrataPrintComissao/imprimir/';
        $data['nome'] = 'NomeColaborador';
    ...
    public function pedidos_entrega_pag() {
        ...
        $data['titulo'] = 'Estático';
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos_entrega_pag';
		$data['comissao'] = 'relatorio/comissao/';
        $data['status'] = 'Orcatrata/alterarstatus/';
		$data['imprimir'] = 'OrcatrataPrintComissao/imprimir/';
        $data['nome'] = 'NomeColaborador';
    ...
    public function pedidos_pagamento_pag() {
        ...
        $data['titulo'] = 'Estático';
        $data['form_open_path'] = 'Pedidos_statico_pag/pedidos_pagamento_pag';
		$data['comissao'] = 'relatorio/comissao/';
        $data['status'] = 'Orcatrata/alterarstatus/';
		$data['imprimir'] = 'OrcatrataPrintComissao/imprimir/';
        $data['nome'] = 'NomeColaborador';
