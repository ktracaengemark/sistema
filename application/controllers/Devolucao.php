...
class Devolucao extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Relatorio_model', 'Servico_model', 'Produto_model', 'Produtos_model', 'ServicoBase_model', 'ProdutoBase_model', 'Produtocompra_model', 'Servicocompra_model', 'Devolucao_model', 'Tipodespesa_model', 'Profissional_model', 'Formapag_model', 'Cliente_model'));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		(!$data['despesas']['TipoProduto']) ? $data['despesas']['TipoProduto'] = 'E' : FALSE;
		(!$data['despesas']['QtdParcelasDespesas']) ? $data['despesas']['QtdParcelasDespesas'] = '0' : FALSE;
        ...
        $data['form_open_path'] = 'devolucao/cadastrar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
			...
			$data['despesas']['idApp_Cliente'] = $data['despesas']['idApp_Cliente'];
            ...
            $data['despesas']['idApp_Despesas'] = $this->Devolucao_model->set_despesas($data['despesas']);
            /*
            ...
            */
            ...
            if (isset($data['servico'])) {
                ...
                $data['servico']['idApp_ServicoCompra'] = $this->Devolucao_model->set_servico_compra($data['servico']);
            }
            ...
            if (isset($data['produto'])) {
                ...
                $data['produto']['idApp_ProdutoCompra'] = $this->Devolucao_model->set_produto_compra($data['produto']);
            }
            ...
            if (isset($data['parcelaspag'])) {
                ...
                $data['parcelaspag']['idApp_ParcelasPagaveis'] = $this->Devolucao_model->set_parcelaspag($data['parcelaspag']);
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($id) {
            #### App_Despesas ####
            $data['despesas'] = $this->Devolucao_model->get_despesas($id);
           ...
           # $_SESSION['Cliente'] = $this->Cliente_model->get_cliente($data['despesas']['idApp_Cliente'], TRUE);
            ...
            #### App_ServicoCompra ####
            $data['servico'] = $this->Devolucao_model->get_servico($id);
            ...
            #### App_ProdutoCompra ####
            $data['produto'] = $this->Devolucao_model->get_produto($id);
            ...
            $data['parcelaspag'] = $this->Devolucao_model->get_parcelaspag($id);
        ...
        $data['form_open_path'] = 'devolucao/alterar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['update']['despesas']['anterior'] = $this->Devolucao_model->get_despesas($data['despesas']['idApp_Despesas']);
            ...
            $data['update']['despesas']['bd'] = $this->Devolucao_model->update_despesas($data['despesas'], $data['despesas']['idApp_Despesas']);

            #### App_ServicoCompra ####
            $data['update']['servico']['anterior'] = $this->Devolucao_model->get_servico($data['despesas']['idApp_Despesas']);
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                if (count($data['update']['servico']['inserir']))
                    $data['update']['servico']['bd']['inserir'] = $this->Devolucao_model->set_servico_compra($data['update']['servico']['inserir']);

                if (count($data['update']['servico']['alterar']))
                    $data['update']['servico']['bd']['alterar'] = $this->Devolucao_model->update_servico_compra($data['update']['servico']['alterar']);

                if (count($data['update']['servico']['excluir']))
                    $data['update']['servico']['bd']['excluir'] = $this->Devolucao_model->delete_servico_compra($data['update']['servico']['excluir']);
            }

            #### App_ProdutoCompra ####
            $data['update']['produto']['anterior'] = $this->Devolucao_model->get_produto($data['despesas']['idApp_Despesas']);
            if (isset($data['produto']) || (!isset($data['produto']) && isset($data['update']['produto']['anterior']) ) ) {
                ...
                if (count($data['update']['produto']['inserir']))
                    $data['update']['produto']['bd']['inserir'] = $this->Devolucao_model->set_produto_compra($data['update']['produto']['inserir']);

                if (count($data['update']['produto']['alterar']))
                    $data['update']['produto']['bd']['alterar'] =  $this->Devolucao_model->update_produto_compra($data['update']['produto']['alterar']);

                if (count($data['update']['produto']['excluir']))
                    $data['update']['produto']['bd']['excluir'] = $this->Devolucao_model->delete_produto_compra($data['update']['produto']['excluir']);

            }

            #### App_ParcelasRec ####
            $data['update']['parcelaspag']['anterior'] = $this->Devolucao_model->get_parcelaspag($data['despesas']['idApp_Despesas']);
            if (isset($data['parcelaspag']) || (!isset($data['parcelaspag']) && isset($data['update']['parcelaspag']['anterior']) ) ) {
                ...
                if (count($data['update']['parcelaspag']['inserir']))
                    $data['update']['parcelaspag']['bd']['inserir'] = $this->Devolucao_model->set_parcelaspag($data['update']['parcelaspag']['inserir']);

                if (count($data['update']['parcelaspag']['alterar']))
                    $data['update']['parcelaspag']['bd']['alterar'] =  $this->Devolucao_model->update_parcelaspag($data['update']['parcelaspag']['alterar']);

                if (count($data['update']['parcelaspag']['excluir']))
                    $data['update']['parcelaspag']['bd']['excluir'] = $this->Devolucao_model->delete_parcelaspag($data['update']['parcelaspag']['excluir']);
...
*/
    ...
    public function excluir($id = FALSE) {
        ...
        elseif ($this->input->get('m') == 2)
            ...
            $data['msg'] = '';
                ...
                $this->Devolucao_model->delete_despesas($id);
    ...
    public function listar($id = NULL) {
        ...
        //$_SESSION['Despesas'] = $this->Devolucao_model->get_cliente($id, TRUE);
        //$_SESSION['Despesas']['idApp_Cliente'] = $id;
        $data['aprovado'] = $this->Devolucao_model->list_despesas($id, 'S', TRUE);
        $data['naoaprovado'] = $this->Devolucao_model->list_despesas($id, 'N', TRUE);
    ...
    public function listarBKP($id = NULL) {
        ...
        //$_SESSION['Despesas'] = $this->Devolucao_model->get_cliente($id, TRUE);
        $_SESSION['Despesas']['idApp_Cliente'] = $id;
        $data['query'] = $this->Devolucao_model->list_despesas(TRUE, TRUE);
        /*
          echo "<pre>";
          print_r($data['query']);
          echo "</pre>";
