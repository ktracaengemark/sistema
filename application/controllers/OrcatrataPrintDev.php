...
class OrcatrataPrintDev extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'OrcatrataPrintDev_model', 'Profissional_model', 'Relatorio_model', 'Formapag_model', 'Clienteusuario_model'));
    ...
    public function imprimir($id = FALSE) {
        ...
        if ($id) {
            #### App_OrcaTrata ####
            $data['orcatrata'] = $this->OrcatrataPrintDev_model->get_orcatrata($id);
            ...
            $_SESSION['Orcatrata'] = $this->OrcatrataPrintDev_model->get_orcatrata($data['orcatrata']['idApp_OrcaTrata'], TRUE);
			#$_SESSION['log']['idApp_Cliente'] = $_SESSION['Cliente']['idApp_Cliente'];

            /*
            #### App_ServicoVenda ####
            $data['servico'] = $this->OrcatrataPrintDev_model->get_servico($id);
            ...
            */
            ...
            #### App_ProdutoVenda ####
            $data['produto'] = $this->OrcatrataPrintDev_model->get_produto($id);
            ...
            $data['parcelasrec'] = $this->OrcatrataPrintDev_model->get_parcelasrec($id);
            ...
            #### App_Procedimento ####
            $data['procedimento'] = $this->OrcatrataPrintDev_model->get_procedimento($id);
        ...
        $this->load->view('orcatrata/printdev_orcatrata', $data);
