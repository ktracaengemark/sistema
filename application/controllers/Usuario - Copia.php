        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['query']['idSis_Usuario'] === FALSE) {
				...
				$data['agenda'] = array(
                    ...
                    'idSis_Usuario' => $data['query']['idSis_Usuario']
                );
                $data['campos'] = array_keys($data['agenda']);

                $data['idApp_Agenda'] = $this->Usuario_model->set_agenda($data['agenda']);
                $data['auditoriaitem'] = $this->basico->set_log($data['anterior'], $data['agenda'], $data['campos'], $data['query']['idSis_Usuario']);
                $data['auditoria'] = $this->Basico_model->set_auditoriaempresa($data['auditoriaitem'], 'App_Agenda', 'CREATE', $data['auditoriaitem'], $data['query']['idSis_Usuario']);
