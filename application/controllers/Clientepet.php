...
class Clientepet extends CI_Controller {
    ...
    public function alterar($id = FALSE) {
		...
		if(!$data['query']['idApp_ClientePet'] || !$_SESSION['ClientePet']){
			unset($_SESSION['ClientePet']);
			unset($_SESSION['Cliente']);
			$data['msg'] = '?m=3';
			redirect(base_url() . 'acesso' . $data['msg']);
			...
			$_SESSION['Cliente'] = $data['cliente'] = $this->Cliente_model->get_cliente($_SESSION['ClientePet']['idApp_Cliente'], TRUE);
    ...
    public function alterarlogopet($id = FALSE) {
		...
		if(!$data['query']['idApp_ClientePet'] || !$_SESSION['ClientePet']){
			...
			$_SESSION['Cliente'] = $this->Cliente_model->get_cliente($_SESSION['ClientePet']['idApp_Cliente'], TRUE);
