...
class Clientedep extends CI_Controller {
    ...
    public function alterar($id = FALSE) {
		...
		if(!$data['query']['idApp_ClienteDep'] || !$_SESSION['ClienteDep']){
			unset($_SESSION['ClienteDep']);
			unset($_SESSION['Cliente']);
			$data['msg'] = '?m=3';
			redirect(base_url() . 'acesso' . $data['msg']);
			...
			$_SESSION['Cliente'] = $data['cliente'] = $this->Cliente_model->get_cliente($_SESSION['ClienteDep']['idApp_Cliente'], TRUE);
    ...
    public function alterarlogodep($id = FALSE) {
		...
		if(!$data['query']['idApp_ClienteDep'] || !$_SESSION['ClienteDep']){
			...
			$_SESSION['Cliente'] = $this->Cliente_model->get_cliente($_SESSION['ClienteDep']['idApp_Cliente'], TRUE);
