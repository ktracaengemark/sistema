...
class Relatorio extends CI_Controller {
	...
	public function receitas() {
        ...
        if ($this->form_validation->run() !== FALSE) {
			...
			if($data['pesquisa_query'] === FALSE){
				...
				$config['base_url'] = base_url() . 'relatorio/receitas_pag/';
				$config['per_page'] = 19;
				$config["uri_segment"] = 3;
				$config['reuse_query_string'] = TRUE;
				$config['num_links'] = 2;
	...
	public function receitas_pag() {
        ...
        $data['titulo'] = 'Receitas';
		$data['form_open_path'] = 'relatorio/receitas_pag';
		$data['baixatodas'] = 'Orcatrata/baixadasreceitas/';
		$data['baixa'] = 'Orcatrata/baixadareceita/';
        $data['nomeusuario'] = 'NomeColaborador';
        $data['status'] = 'StatusComissaoOrca';
	...
	public function receitas_lista() {
        ...
        $data['titulo'] = 'Receitas';
		$data['form_open_path'] = 'Relatorio/receitas_lista';
		$data['baixatodas'] = 'Orcatrata/baixadasreceitas/';
		$data['baixa'] = 'Orcatrata/baixadareceita/';
        $data['nomeusuario'] = 'NomeColaborador';
        $data['status'] = 'StatusComissaoOrca';
        ...
        #run form validation
			...
			if($data['pesquisa_query'] === FALSE){
				...
				$config['base_url'] = base_url() . 'Relatorio/receitas_lista/';
				$config['per_page'] = 19;
				$config["uri_segment"] = 3;
				$config['reuse_query_string'] = TRUE;
				$config['num_links'] = 2;
	...
	public function comissao() {
		...
		$data['imprimir'] = 'OrcatrataPrint/imprimir/';
		$data['imprimirlista'] = 'Relatorio/comissao_lista/';
		$data['imprimirrecibo'] = 'Relatorio/comissao_recibo/';
		$data['edit'] = 'orcatrata/alterarstatus/';
		$data['alterarparc'] = 'Orcatrata/alterarparcelarec/';
		$data['paginacao'] = 'N';
		$data['Associado'] = 0;
        ...
        if ($this->form_validation->run() !== FALSE) {
			...
			if($data['pesquisa_query'] === FALSE){
				...
				$config['base_url'] = base_url() . 'relatorio/comissao_pag/';
				$config['per_page'] = 19;
				$config["uri_segment"] = 3;
				$config['reuse_query_string'] = TRUE;
				$config['num_links'] = 2;
	...
	public function comissao_pag() {
		...
		$data['form_open_path'] = 'relatorio/comissao_pag';
		$data['baixatodas'] = 'Orcatrata/baixadacomissao/';
		$data['baixa'] = 'Orcatrata/baixadareceita/';
		$data['nomeusuario'] = 'NomeColaborador';
		$data['status'] = 'StatusComissaoOrca';
	...
	public function comissao_lista() {
		...
		if($data['pesquisa_query'] === FALSE){
			...
			$config['base_url'] = base_url() . 'relatorio/comissao_lista/';
			...
			$data['list1'] = $this->load->view('Relatorio/list_comissao_lista', $data, TRUE);
		}
        $this->load->view('relatorio/tela_comissao', $data);
	...
	public function comissao_excel($id = FALSE) {
		...
		if($data['report'] === FALSE){
			...
			$data['list1'] = $this->load->view('Relatorio/list_comissao_excel', $data, TRUE);
		}
	...
	public function comissaoass_pag() {
		...
		//$data['query']['nome'] = 'Cliente';
		$data['titulo'] = 'Comissão Associado';
		$data['form_open_path'] = 'relatorio_pag/comissaoass_pag';
		$data['baixatodas'] = 'Orcatrata/baixadacomissaoass/';
		$data['baixa'] = 'Orcatrata/baixadareceita/';
		$data['nomeusuario'] = 'NomeAssociado';
		$data['status'] = 'StatusComissaoOrca';
		$data['alterar'] = 'relatorio/comissaoass/';
		$data['editar'] = 1;
		$data['metodo'] = 1;
		$data['panel'] = 'info';
		$data['TipoFinanceiro'] = 'Receitas';
		...
		$data['paginacao'] = 'S';
		$data['caminho'] = 'relatorio/comissaoass/';
	...
	public function comissaoass_lista() {
		...
		if($data['pesquisa_query'] === FALSE){
			...
			$config['base_url'] = base_url() . 'relatorio_print/comissaoass_lista/';
			...
			$data['list1'] = $this->load->view('Relatorio_print/list_comissaoass_lista', $data, TRUE);
		}
        $this->load->view('relatorio/tela_comissaoass', $data);
	...
	public function comissaofunc() {
		...
		$data['form_open_path'] = 'relatorio/comissaofunc';
...
*/
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
			...
			if($data['pesquisa_query'] === FALSE){
				...
				$config['base_url'] = base_url() . 'relatorio/cobrancas_pag/';
	...
	public function cobrancas_pag() {
		...
		$data['metodo'] = 2;
		$data['form_open_path'] = 'relatorio/cobrancas_pag';
		$data['panel'] = 'info';
		$data['TipoFinanceiro'] = 'Receitas';
		$data['TipoRD'] = 2;
        $data['nome'] = 'Cliente';
		...
		if (!$id) {
			...
			if($_SESSION['log']['idSis_Empresa'] !== $id){
				...
				if($data['pesquisa_query'] === FALSE){
					...
					$config['total_rows'] = $data['pesquisa_query']->num_rows();
					$config['base_url'] = base_url() . 'Relatorio/cobrancas_lista/' . $id . '/';
					$config['per_page'] = 19;
					...
					*/
					...
					$data['form_open_path'] = 'Relatorio/cobrancas_lista';
					$data['panel'] = 'info';
					$data['metodo'] = 1;
					$data['imprimir'] = 'OrcatrataPrint/imprimir/';
					$data['imprimirlista'] = 'Relatorio/cobrancas_lista/';
					...
					$this->load->view('Relatorio/list_cobrancas_lista', $data);
				}
			}	
		}
        $this->load->view('basico/footer');
		...
		if (!$id) {
			...
			if($_SESSION['log']['idSis_Empresa'] !== $id){
				...
				if($data['pesquisa_query'] === FALSE){
					...
					//$config['total_rows'] = $data['pesquisa_query'];
					$config['total_rows'] = $data['pesquisa_query']->num_rows();
					$config['base_url'] = base_url() . 'Relatorio/cobrancas_recibo/' . $id . '/';
					$config['per_page'] = 12;
					$config["uri_segment"] = 4;
					$config['reuse_query_string'] = TRUE;
					$config['num_links'] = 2;
					...
					$data['form_open_path'] = 'Relatorio/cobrancas_recibo';
					$data['panel'] = 'info';
					$data['metodo'] = 1;
					$data['imprimir'] = 'OrcatrataPrint/imprimir/';
					$data['imprimirlista'] = 'Relatorio/cobrancas_lista/';
					...
					$this->load->view('Relatorio/list_cobrancas_recibo', $data);			
				}
			}
		}
        $this->load->view('basico/footer');
