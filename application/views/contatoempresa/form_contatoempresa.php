							...
							<div class="panel panel-<?php echo $panel; ?>">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-md-4">
												<label for="Nome">Nome do Contatoempresa: *</label>
												<input type="text" class="form-control" id="Nome" maxlength="255" <?php echo $readonly; ?>
													   name="Nome" autofocus value="<?php echo $query['Nome']; ?>">
											</div>
											<div class="col-md-4">
												<label for="Celular">Telefone Principal: *</label>
												<input type="text" class="form-control Celular CelularVariavel" id="Celular" maxlength="20" <?php echo $readonly; ?>
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<div class="col-md-6 text-right">
																	<a class="btn btn-danger" href="<?php echo base_url() . 'contatoempresa/excluir/' . $query['idSis_Usuario'] ?>" role="button">
