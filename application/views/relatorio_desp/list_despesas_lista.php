	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="navbar-header">
			...
			<div class="btn-menu-print btn-group">
				...
				<a type="button" class="col-md-3 btn btn-md btn-warning "  href="<?php echo base_url() ?>relatorio_desp/despesas_pag">
			...
			<table class="table table-bordered table-condensed table-striped">
				<thead>						
					<tr>
						...
						<th class="col-md-1" scope="col">Despesa</th>
						<th class="col-md-1" scope="col">DtDespesa</th>
