<div class="container text-center" id="login">
    ...
    <p><a href="<?php echo base_url(); ?>logincliente/recuperar/?usuario=<?php echo set_value('Usuario'); ?>">Esqueci Cliente/senha!</a></p>
	<br>
    ...
    <!--<a class="btn btn btn-primary btn-warning" href="<?php echo base_url(); ?>logincliente/registrar" role="button">Cadastrar Nova Empresa</a>-->
</form>
