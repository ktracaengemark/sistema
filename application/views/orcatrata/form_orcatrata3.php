													...
													<div class="form-group">	
														<div class="row">
															...
															<?php if($_SESSION['Empresa']['CadastrarPet'] == "S"){?>
																...
																<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-left">
																	<label  for="idApp_ClientePet">Pet</label><br>
															...
															<?php }else{ ?>
																<?php if($_SESSION['Empresa']['CadastrarDep'] == "S"){?>
																	...
																	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-left">
																		<label  for="idApp_ClienteDep">Dependente</label><br>
													...
													<div class="form-group">
														<div class="row">
															<div class="col-xs-6 col-sm-3  col-md-3 col-lg-3 text-left">
																<label for="Cadastrar">Cliente/Pet/Dep.?</label><br>
																<div class="btn-larg-right btn-group" data-toggle="buttons">
																	<?php
												...
												<div class="panel-heading">	
													...
													<div id="DetalhadaEntrega" <?php echo $div['DetalhadaEntrega']; ?>>
														...
														<div class="row">	
															...
															<div class="col-sm-4 col-md-4 ">
																<label class="" for="ParentescoRec">Relação:</label>
																		...
																		<div id="UsarCupom" <?php echo $div['UsarCupom']; ?>>	
																			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
																				...
																				<div class="input-group" id="txtHint">
																					...
																					<input type="text" class="form-control Numero" name="Cupom" id="Cupom" maxlength="11" placeholder="1234" onkeyup="cupom()" value="<?php echo $orcatrata['Cupom'] ?>">
																				</div>
																			</div>
																		</div>
																	</div>
