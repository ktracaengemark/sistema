								...
								<div class="col-md-12 ">
									<div class="col-md-2 text-left">
										...
										<?php if ($titulo == "Receitas" ) { ?>
											<a type= "button" class="btn btn-md btn-warning btn-block" href="<?php echo base_url() ?>relatorio_pag/cobrancas_pag" role="button">
							...
							<div class="panel-group">
								<div  style="overflow: auto; height: 456px; ">
									...
									?>
										...
										<input type="hidden" name="FormaPagamentoParcela<?php echo $i ?>" value="<?php echo $parcelasrec[$i]['FormaPagamentoParcela']; ?>"/>
												...
												<div class="panel-heading">
													<div class="row">
														<div class="col-md-1">
															...
															<span><?php echo $_SESSION['Parcelasrec'][$i]['Parcela'] ?></span>
														</div>
														<?php if ($titulo == "Receitas") { ?>
														<div class="col-md-2">
