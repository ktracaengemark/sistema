						...
						<div class="col-md-12 ">
							<div class="col-md-2 text-left">
								...
								<?php if ($_SESSION['log']['NivelEmpresa'] >= 4 ) { ?>
									<a class="btn btn-md btn-warning btn-block" href="<?php echo base_url() ?>Comprados/comprados_pag" role="button">
							...
							<div class="col-md-2 text-left">	
								...
								<a type= "button" class="btn btn-md btn-warning btn-block" role="button">
									<?php echo $_SESSION['Filtro_Comprados']['Total_Rows'];?> Resultados
								</a>
							</div>
							<div class="col-md-6 text-left">
								<?php echo $_SESSION['Filtro_Comprados']['Pagination']; ?>
							</div>
						</div>
					</div>
				</div>						
															...
															<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
																<div class="row">
																	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
																		<label >
																			<?php echo $contagem ?>/<?php echo $_SESSION['Filtro_Comprados']['Total_Rows'];?> |
																			<a class="notclickable" href="<?php echo base_url() . 'cliente/prontuario/' . $_SESSION['Produto'][$i]['idApp_Fornecedor']; ?>">
																				<span class="glyphicon glyphicon-edit notclickable"></span> <?php echo $_SESSION['Produto'][$i]['idApp_Fornecedor']; ?>
																			</a>
																			| Fornecedor 
																		</label>
																		<input type="text" class="form-control " readonly="" value="<?php echo $_SESSION['Produto'][$i]['NomeFornecedor']; ?>">
																	</div>
																	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
																		<label >
