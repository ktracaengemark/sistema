            ...
            <ul class="nav navbar-nav">             
                ...
                <li class="dropdown <?php if (substr(uri_string(), 0, strpos(uri_string(), '/')) == 'contatocliente') { echo 'active'; } ?>">
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="<?php echo base_url() ?>cliente/pesquisar">Pesq/Cad Clientes</a></li>						
						<!--<li><a href="<?php echo base_url() ?>cliente/pesquisar">Pesq. Clientes</a></li>-->
						
						<li role="separator" class="divider"></li>
						
                        <li><a href="<?php echo base_url() ?>cliente/pesquisar"> Pesq/Cad Contato/Resp.</a></li>
                ...
                <li class="dropdown <?php if (substr(uri_string(), 0, strpos(uri_string(), '/')) == 'consulta') { echo 'active'; } ?>">
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="<?php echo base_url() ?>cliente/pesquisar">Orçam. e PL.Tratam.</a></li>
				...
				<li class="dropdown <?php if (substr(uri_string(), 0, strpos(uri_string(), '/')) == 'tabelas') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu"> 
					    ...
					    <li><a href="<?php echo base_url() ?>profissional/pesquisar">Pesq/Cad Func/Profis.</a></li>
												
					    <li role="separator" class="divider"></li>
						
						<li><a href="<?php echo base_url() ?>empresa/pesquisar">Pesq/Cad Empresas/Prest.Serv</a></li>						
																								
						<li role="separator" class="divider"></li>
						
						<li><a href="<?php echo base_url() ?>funcao/cadastrar/funcao">Função dos Func. e Prof.</a></li>						
						<li><a href="<?php echo base_url() ?>atividade/cadastrar/atividade">Ativ. das Empresas/Prest.Serv.</a></li>
