			...
			<table class="table table-bordered table-condensed table-striped">	
				<thead>
					<tr>
						...
						<th class="col-md-2" scope="col">Fornecedor</th>
				...
				<tbody>
					<?php
						...
						<tr>
							...
							<td class="col-md-1" scope="col"><?php echo $orcatrata[$i]['idApp_Fornecedor'] ?></td>
							<td class="col-md-2" scope="col"><?php echo $orcatrata[$i]['NomeFornecedor'] ?></td>
							<td class="col-md-2" scope="col"><?php echo $orcatrata[$i]['CelularFornecedor'] ?>
