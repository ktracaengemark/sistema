					...
					<thead>
						<tr>
							...
							<td class="col-md-3 text-left" scope="col"><?php echo '<strong>' . $_SESSION['Empresa']['NomeEmpresa'] . '</strong>'
																				. '<br><br><strong>' . $orcatrata[$i]['NomeFornecedor'] . '</strong> - ' . $orcatrata[$i]['idApp_Fornecedor'] . ''
																				. '<br>' . $orcatrata[$i]['EnderecoFornecedor'] . ' - ' . $orcatrata[$i]['NumeroFornecedor'] . ''
																				. '<br>' . $orcatrata[$i]['ComplementoFornecedor'] . ' - ' . $orcatrata[$i]['BairroFornecedor'] . ' - ' . $orcatrata[$i]['CidadeFornecedor'] . ' - ' . $orcatrata[$i]['EstadoFornecedor'] . '<br>' . $orcatrata[$i]['ReferenciaFornecedor'] . ''
																				. '<br>Tel.:' . $orcatrata[$i]['CelularFornecedor'] . ' / ' . $orcatrata[$i]['Telefone2'] . ' / ' . $orcatrata[$i]['Telefone3'] . ''
																		?></td>
