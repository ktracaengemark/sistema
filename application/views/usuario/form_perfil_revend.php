<?php if ( !isset($evento) && isset($_SESSION['Empresa']) && isset($_SESSION['Revendedor'])) { ?>
								...
								<div class="panel panel-info">
									<div class="panel-heading">						
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-8">
													...
													<input type="text" class="form-control" readonly='' value="<?php echo $_SESSION['Revendedor']['Nome']; ?>">
												</div>
											</div>
										</div>				
										<?php if ($metodo != 3) { ?>
										<div class="form-group">
											<div class="row">
												<div class="col-md-12 "> 
													<a href="<?php echo base_url() . 'Revendedor/prontuario/' . $_SESSION['Revendedor']['idSis_Usuario']; ?>">
														<img alt="User Pic" src="<?php echo base_url() . '../'.$_SESSION['log']['Site'].'/' . $_SESSION['Empresa']['idSis_Empresa'] . '/usuarios/miniatura/' . $_SESSION['Revendedor']['Arquivo'] . ''; ?>" 
