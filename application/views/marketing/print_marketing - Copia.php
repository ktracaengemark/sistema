							...
							<div class="collapse navbar-collapse" id="myNavbar">
								<ul class="nav navbar-nav navbar-center">
									...
									<li class="botoesnav" role="toolbar" aria-label="...">
										<div class="btn-group">
											...
											<ul class="dropdown-menu" role="menu">
												...
												<li role="separator" class="divider"></li>
												<li>
													<a <?php if (preg_match("/marketing\/cadastrar\b/", $_SERVER['REQUEST_URI'])) echo 'class=active'; ///(.)+\/cadastrar1/    ?>>
									...
									<?php if ($_SESSION['Usuario']['Edit_Orcam'] == "S" ) { ?>
										<li class="botoesnav" role="toolbar" aria-label="...">
											<div class="btn-group">
												<a type="button" class="btn btn-md btn-default " href="<?php echo base_url() . 'marketing/alterar_' . $alterar . '/' . $query['idApp_Marketing']; ?>">
									...
									<li class="botoesnav" role="toolbar" aria-label="...">
										<div class="btn-group">
											<a type="button" class="btn btn-md btn-default " href="<?php echo base_url() . 'marketing/tela_' . $imprimir . '/' . $query['idApp_Marketing']; ?>">
