                    ...
                    <div role="tabpanel" class="tab-pane active" id="proxima">
                        ...
                        if ($proxima) {
                            ...
                            foreach ($proxima->result_array() as $row) {
                                ...
                                echo '<div data-href="' . base_url() . 'despesas/alterar/' . $row['idApp_Cliente'] . '/' . $row['idApp_Despesas'] . '" '
                            ...
                            echo '<br><div class="alert alert-info text-center" role="alert"><b>Nenhuma despesas registrada</b></div>';
                        }
                        ?>

                    </div>

                    <!-- Histórico de Despesass -->
