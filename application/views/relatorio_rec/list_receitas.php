	...
	<div class="panel-heading">
		<div class="row">
			...
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-6 text-left">
				...
				<a href="<?php echo base_url() . 'Relatorio_rec/receitas_excel/2'; ?>">
				...
				<?php if($_SESSION['Usuario']['Bx_Prd'] == "S" && $_SESSION['Usuario']['Bx_Pag'] == "S" && $_SESSION['Usuario']['Nivel'] != 2) {?>
					<?php if ($editar == 1) { ?>
						<?php if ($print == 1) { ?>	
							<div class="col-lg-1 col-md-1 col-sm-1 col-xs-6 text-left">
								<label>Lista</label>
								<a href="<?php echo base_url() . 'Relatorio_rec/receitas_lista'; ?>">
						...
						<div class="col-lg-1 col-md-1 col-sm-1 col-xs-6 text-left">
							<label>Editar</label>
							<a href="<?php echo base_url() . 'relatorio_rec/receitas_pag'; ?>">
								<button class="btn btn-<?php echo $panel; ?> btn-md btn-block" type="button">
									<span class="glyphicon glyphicon-list"></span>
								</button>
							</a>
