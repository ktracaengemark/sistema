				...
				<table class="table table-bordered table-condensed table-striped">								
					...
					<tbody>
						...
						foreach ($report->result_array() as $row) {
							...
							#echo '<tr class="clickable-row" data-href="' . base_url() . 'tarefa/alterar/' . $row['idApp_Tarefa'] . '">';
							#echo '<tr class="clickable-row" data-href="' . base_url() . 'orcatrata/alterartarefa/' . $row['idSis_Empresa'] . '">';

								/*
									echo '<td class="notclickable">
										<a class="btn btn-md btn-info notclickable" href="' . base_url() . 'orcatrata/alterartarefa/' . $row['idSis_Empresa'] . '">
								...
								*/
								if($row['idSis_Usuario'] == $_SESSION['log']['idSis_Usuario']){
									echo '<td class="notclickable">
											<a class="btn btn-md btn-success notclickable" href="' . base_url() . 'tarefa/baixadatarefa/' . $row['idApp_Tarefa'] . '">
								...
								echo '<td class="notclickable">
										<a class="btn btn-md btn-primary notclickable" href="' . base_url() . 'tarefa/alterar/' . $row['idApp_Tarefa'] . '">
											<span class="glyphicon glyphicon-edit notclickable"></span>
										</a>
									</td>';
								...
								/*
								echo '<td class="notclickable">
										<a class="btn btn-md btn-danger notclickable" href="' . base_url() . 'tarefa/excluir/' . $row['idApp_Tarefa'] . '">
