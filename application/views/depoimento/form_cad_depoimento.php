									...
									<div class="col-md-6 ">	
										...
										<div class="col-md-10">
											<div class="row">	
												...
												<input type="text" class="form-control" id="Nome_Depoimento" maxlength="45" 
														name="Nome_Depoimento" value="">
											</div>
										</div>
										<div class="col-md-10">
											<div class="row">	
												<label for="Texto_Depoimento">Texto:</label>
												<input type="text" class="form-control" id="Texto_Depoimento" maxlength="45" 
														name="Texto_Depoimento" value="">
											</div>
										</div>
										<div class="col-md-10">
											<div class="row">												
						...
						<div class="row">
							...
							<?php if ($metodo == 2) { ?>
								...
								<div class="col-md-4 text-right">
										<a class="btn btn-lg btn-warning" href="<?php echo base_url() . 'relatorio/depoimento/'?>">
											<span class="glyphicon glyphicon-file"></span> Voltar
										</a>
								</div>								
								<div class="col-md-4 text-right">
