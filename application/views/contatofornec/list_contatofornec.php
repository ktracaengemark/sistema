<?php (isset($contatofornec)) ? $query = $contatofornec : FALSE; ?>
...
foreach ($query->result_array() as $row) {
    ...
    ?>
        ...
        <div class="bs-callout bs-callout-<?php echo $row['class']; ?>" id=callout-overview-not-both> 
            ...
            <a class="btn btn-<?php echo $row['class']; ?>" href="<?php echo base_url() . 'contatofornec/alterar/' . $row['idApp_Contatofornec'] ?>" role="button"> 
            ...
            <h4>
                ...
                <?php echo $row['NomeContatofornec'] . '</small></code>'; ?>
                <?php echo $row['vida']; ?>
			...
			<p>	
				<?php if ($row['TelefoneContatofornec']) { ?>
				<span class="glyphicon glyphicon-phone-alt"></span> <b>Telefone:</b> <?php echo $row['TelefoneContatofornec']; ?>
				<?php } ?>
            </p>
			<p>	
				<?php if ($row['Ativo']) { ?>
