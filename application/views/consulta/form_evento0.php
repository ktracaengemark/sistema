										...
										<div class="panel-heading">
											<div class="row">
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left">
													...
													<textarea class="form-control" id="Obs" name="Obs" readonly="" rows="1"><?php echo $query['Obs']; ?></textarea>
												</div>
											</div>
											<div class="row">
												<div class="col-xs-11 col-sm-7 col-md-7 col-lg-6">	
													...
													<div class="btn-larg-right input-group <?php echo $datepicker; ?>">
														...
														<input type="text" class="form-control Date"  readonly=""  maxlength="10" placeholder="DD/MM/AAAA"
												...
												<div class="col-xs-12 col-sm-5 col-md-5 col-lg-6">
													<label for="Hora">Dàs :</label>
														<input type="text" class="form-control Time"  readonly=""  maxlength="5"  placeholder="HH:MM"
