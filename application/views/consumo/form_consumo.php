											...
											<div class="panel-heading">
												<div class="row">
													...
													<div class="col-md-4">
														...
														<?php } ?>
														<select data-placeholder="Selecione uma opção..." class="form-control" onchange="buscaValorConsumo(this.value,this.name,'Servico',<?php echo $i ?>)" <?php echo $readonly; ?>
													...
													<div class="col-md-3">
														<label for="ValorConsumoServico">Valor do Serviço:</label>
											...
											<div class="panel-heading">
												<div class="row">
													...
													<div class="col-md-4">
														...
														<?php } ?>
														<select data-placeholder="Selecione uma opção..." class="form-control" onchange="buscaValorConsumo(this.value,this.name,'Produto',<?php echo $i ?>)" <?php echo $readonly; ?>
										...
										<div class="panel panel-info">
											<div class="panel-heading">
												<div class="row">
													...
													<div class="col-md-2">
														<label for="DataVencimentoConsumo">Data do 1º Venc.</label>
														<div class="input-group <?php echo $datepicker; ?>">
						...
						<!--
							...
							<div class="form-group">
								...
								<div id="AprovadoConsumo" <?php echo $div['AprovadoConsumo']; ?>>									
									<div class="col-md-2 form-inline">
										<label for="ServicoConcluidoConsumo">Consumo Concluída?</label><br>
										<div class="form-group">
											<div class="btn-group" data-toggle="buttons">
												<?php
									...
									<div id="QuitadoConsumo" <?php echo $div['QuitadoConsumo']; ?>>	
										<div class="col-md-2">
											<label for="DataConclusaoConsumo">Data da Quitação:</label>
											<div class="input-group <?php echo $datepicker; ?>">
												<input type="text" class="form-control Date" <?php echo $readonly; ?> maxlength="10" placeholder="DD/MM/AAAA"
