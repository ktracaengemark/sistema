		...
		<div class="banner-info">
			<div class="row">
				<div class="col-lg-offset-3 col-lg-6  col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 col-xs-12 text-center">
					...
					<?php echo form_open('login/index', 'role="form"'); ?>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
						<div class="row acabamento text-center">
							...
							<div class="col-md-offset-1 col-md-10 col-sm-offset-1 col-sm-10 col-xs-12 text-center">	
								...
								<input type="text" id="CelularUsuario" maxlength="11" class="form-control acabamento3" placeholder="Celular (xx)999999999" autofocus name="CelularUsuario" value="<?php echo set_value('CelularUsuario'); ?>">	   
