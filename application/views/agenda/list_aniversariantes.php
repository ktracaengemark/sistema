						...
						foreach ($report->result_array() as $row) {
							...
							#echo '<tr class="clickable-row" data-href="' . base_url() . 'tarefa/alterar/' . $row['idApp_Procedimento'] . '">';
								...
								echo '<td class="notclickable">
										' . $row['CelularCliente'] . '
										<a class="notclickable" href="https://api.whatsapp.com/send?phone=55'.$row['CelularCliente'].'&text='.$_SESSION['FiltroAlteraProcedimento']['Texto1'].' '.$row['NomeCliente'].' '.$_SESSION['FiltroAlteraProcedimento']['Texto2'].'" target="_blank">
