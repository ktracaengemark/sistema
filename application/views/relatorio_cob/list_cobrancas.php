					...
					foreach ($report->result_array() as $row) {
						echo '<tr>';
							...
							if($_SESSION['log']['idSis_Empresa'] != "5"){
								...
								if(isset($_SESSION['FiltroCobrancas']['nomedo' . $nome]) && $_SESSION['FiltroCobrancas']['nomedo' . $nome] == "S") {
									$nomedo_ = $row['Nome' . $nome];
								}else{
									$nomedo_ = FALSE;
								}
								
								if(isset($_SESSION['FiltroCobrancas']['numerodopedido']) && $_SESSION['FiltroCobrancas']['numerodopedido'] == "S") {
								...
								if($metodo == 1 || $metodo == 2) {
									$whatsapp = '<a class="notclickable" href="https://api.whatsapp.com/send?phone=55'.$row['Celular' . $nome].'&text='.$_SESSION['FiltroCobrancas']['Texto1'].' '.$nomedo_.' '.$_SESSION['FiltroCobrancas']['Texto2'].' '.$numerodopedido.' '.$_SESSION['FiltroCobrancas']['Texto3'].'  " target="_blank">
