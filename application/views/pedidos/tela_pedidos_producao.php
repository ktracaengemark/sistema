					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 text-left">
								...
								<a class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>pedidos/pedidos" role="button"> 
				...
				<?php if ($_SESSION['log']['idSis_Empresa'] != 5 ) { ?>
								...
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 text-left">
											<a class="text-center" style="color: #00008B" href="<?php echo base_url() ?><?php echo $pedidos; ?>/pedidos_producao" role="button">
												<h5 class="text-left">Aguardando <b>Produção</b> - <?php echo $report_producao->num_rows(); ?> / <?php echo $total_rows; ?> resultado(s)</h5>
											</a>
										</div>
										<?php if($paginacao == "N") { ?>
											<div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 text-left">
					...
					<div class="row">			
						<div class="col-md-12">
							<div class="panel panel-success">
								<div class="panel-heading">
									<a class="text-center" style="color: #3CB371" href="<?php echo base_url() ?><?php echo $pedidos; ?>/pedidos_envio" role="button">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-warning">
								<div class="panel-heading">
									<a class="text-center" style="color: #B8860B" href="<?php echo base_url() ?><?php echo $pedidos; ?>/pedidos_entrega" role="button">
					...
					<div class="row">			
						<div class="col-md-12">
							<div class="panel panel-warning">
								<div class="panel-heading">
									<a class="text-center" style="color: #B8860B" href="<?php echo base_url() ?><?php echo $pedidos; ?>/pedidos_pagamento" role="button">
