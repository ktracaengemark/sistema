				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-2">
									<label for="DataInicio">Orç - Data Inc.</label>
								...
								<div class="col-md-2">
									<label for="DataFim">Orç - Data Fim</label>
									<div class="input-group DatePicker">
										<input type="text" class="form-control Date" maxlength="10" placeholder="DD/MM/AAAA"
								...
								<div class="col-md-2">
									<label for="DataInicio2">Entr. - Data Inc.</label>
									<div class="input-group DatePicker">
										<input type="text" class="form-control Date" maxlength="10" placeholder="DD/MM/AAAA"
								...
								<div class="col-md-2">
									<label for="DataFim2">Entr - Data Fim</label>
									<div class="input-group DatePicker">
										<input type="text" class="form-control Date" maxlength="10" placeholder="DD/MM/AAAA"
								...
								<div class="col-md-2">
									<label for="DataInicio3">Ret.- Data Inc.</label>
									<div class="input-group DatePicker">
										<input type="text" class="form-control Date" maxlength="10" placeholder="DD/MM/AAAA"
								...
								<div class="col-md-2">
									<label for="DataFim3">Ret.- Data Fim</label>
									<div class="input-group DatePicker">
										<input type="text" class="form-control Date" maxlength="10" placeholder="DD/MM/AAAA"
