						...
						if(isset($row->NomeCliente)) {
							...
							echo '<tr>';
								...
								echo '<td class="notclickable">
										' . $row->CelularCliente . '
										<a class="notclickable" href="https://api.whatsapp.com/send?phone=55'.$row->CelularCliente.'&text=Oi '.$row->NomeCliente.', voce possui R$'.$row->CashBackCliente.' em Cashback, na nossa loja, validos ate '.$row->ValidadeCashBack.', aproveite! Visite nosso Site https://enkontraki.com.br/'.$_SESSION['Empresa']['Site'].'" target="_blank">
