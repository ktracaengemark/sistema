                ...
                <tbody>
                    ...
                    #for($i=0;$i<count($report);$i++) {
                        ...
                        if(isset($row['NomeCliente'])) {
                            $row['QtdParc'] = (isset($row['QtdParc'])) ? $row['QtdParc'] : '0,00';
                            $row['QtdOrcam'] = (isset($row['QtdOrcam'])) ? $row['QtdOrcam'] : '0,00';
                            $row['QtdDescon'] = (isset($row['QtdDescon'])) ? $row['QtdDescon'] : '0,00';
                            $row['QtdDevol'] = (isset($row['QtdDevol'])) ? $row['QtdDevol'] : '0,00';
