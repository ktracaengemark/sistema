	...
	<div class="panel-heading">
		...
		<div class="row">
			...
			<div class="col-lg-1 col-md-2 col-sm-2 col-xs-6 text-left">
				...
				<a href="<?php echo base_url() . 'Relatorio_print/debitos_excel/2'; ?>">
			...
			<div class="col-lg-1 col-md-2 col-sm-2 col-xs-6 text-left">
				<label>Excel</label><br>
				<a href="<?php echo base_url() . 'Relatorio_print/debitos_excel/3'; ?>">
					<button type='button' class='btn btn-md btn-success btn-block'>
					...
					foreach ($report->result_array() as $row) {
						echo '<tr>';
							...
							if($_SESSION['log']['idSis_Empresa'] != "5"){
								...
								if(isset($_SESSION['FiltroDebitos']['nomedo' . $nome]) && $_SESSION['FiltroDebitos']['nomedo' . $nome] == "S") {
									$nomedo_ = $row['Nome' . $nome];
								}else{
									$nomedo_ = FALSE;
								}
								
								if(isset($_SESSION['FiltroDebitos']['numerodopedido']) && $_SESSION['FiltroDebitos']['numerodopedido'] == "S") {
								...
								if($metodo == 1 || $metodo == 2) {
									$whatsapp = '<a class="notclickable" href="https://api.whatsapp.com/send?phone=55'.$row['Celular' . $nome].'&text='.$_SESSION['FiltroDebitos']['Texto1'].' '.$nomedo_.' '.$_SESSION['FiltroDebitos']['Texto2'].' '.$numerodopedido.' '.$_SESSION['FiltroDebitos']['Texto3'].'  " target="_blank">
