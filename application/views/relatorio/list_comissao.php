				...
				<div class="row">		
					...
					<?php if($_SESSION['Usuario']['Bx_Prd'] == "S" && $_SESSION['Usuario']['Bx_Pag'] == "S" && $_SESSION['Usuario']['Nivel'] != 2) {?>
						<?php if ($editar == 1) { ?>
							...
							<?php } ?>
							<?php if(isset($_SESSION['FiltroComissao']['NomeUsuario']) && $_SESSION['FiltroComissao']['NomeUsuario'] != 0 && isset($total_rows) && $total_rows >= 1) { ?>	
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-left">
									<label>Baixa</label>
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 text-left">
									<label>Recibo</label>
									<a href="<?php echo base_url() . $recibo . $_SESSION['log']['idSis_Empresa']; ?>">
