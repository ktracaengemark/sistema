				...
				<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-12 ">
									<div class="col-md-6 ">	
										...
										<div class="col-md-12 ">
											<div class="row">	
												<a href="<?php echo base_url() . 'relatorio/colaborador/'; ?>">
													<img alt="User Pic" src="<?php echo base_url() . '../'.$_SESSION['log']['Site'].'/' . $_SESSION['Empresa']['idSis_Empresa'] . '/documentos/miniatura/' . $_SESSION['Colaborador']['Arquivo_Colaborador'] . ''; ?>" 
										...
										<div class="col-md-10">
											<div class="row">	
												...
												<input type="text" class="form-control" id="Nome_Colaborador" maxlength="45" 
														name="Nome_Colaborador" value="">
											</div>
										</div>
										<div class="col-md-10">
											<div class="row">	
												<label for="Texto_Colaborador">Texto:</label>
												<input type="text" class="form-control" id="Texto_Colaborador" maxlength="45" 
														name="Texto_Colaborador" value="">
											</div>
										</div>
										<div class="col-md-10">
											<div class="row">												
					...
					<div class="form-group">
						<div class="row">
							...
							<input type="hidden" name="idApp_Colaborador" value="<?php echo $file['idApp_Colaborador']; ?>">
							<div class="col-md-6">                            
						...
						<div class="row">
							...
							<?php if ($metodo == 2) { ?>
								...
								<div class="col-md-4 text-right">
										<a class="btn btn-lg btn-warning" href="<?php echo base_url() . 'relatorio/colaborador/'?>">
											<span class="glyphicon glyphicon-file"></span> Voltar
										</a>
								</div>								
								<div class="col-md-4 text-right">
